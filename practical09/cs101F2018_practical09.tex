...
output word counts for the paragraph in a provided file. You should also add the
required source code so that the program produces the expected output. Finally,
make sure that you run the program and paste its output at the bottom of the
file! You should observe that the code uses the \program{java.util.TreeMap} ---
how does the program's output change if you replace that with a
\program{java.util.HashMap} instead? You should also be able to explain how the
program performs input parsing and sorting of the populated \program{TreeMap}.
Please see the instructor with your questions about this program!
