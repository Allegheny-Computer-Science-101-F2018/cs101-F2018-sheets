...
\begin{enumerate}
  ...
  \item If you do not already have a GitHub account, then please go to the
    ...
    \channel{#labs} channel of our Slack team, please type on one line your full
    name, \command{allegheny.edu} email address, and your new GitHub username.
    If you have already typed this information into Slack during a prior class,
...
\item Stored in a Markdown file called \reflection{}, a one-paragraph response,
  each consisting of at least three sentences, for each of the following
  questions.
...
\item Stored in a Markdown file called \reflection{}, a one-paragraph (at least
  three sentence) reflection on the challenges you faced and the steps that you
  took to solve them.
