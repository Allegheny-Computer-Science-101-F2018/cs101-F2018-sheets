...
\newcommand{\labtitle}[1]
{
  \begin{center}
    \begin{center}
      \bf
      CMPSC 101\\Introduction to Computer Science II\\
      Fall 2018\\
      \medskip
    \end{center}
    \bf
...
``Allegheny-Computer-Science-101-Fall-2018/computer-science-101-spring-2018-lab-1-gkapfham''. Unless you provide the
...
\command{mkdir cs101F2018}. To enter into this directory you should now type \command{cd cs101F2018}. Next, you can type
