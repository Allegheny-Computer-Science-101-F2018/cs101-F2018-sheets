...
Gradle will run the provided JUnit tests, check to ensure that
\mainprogram{} produces exactly six lines of output, and see that you committed
to GitHub a sufficient number of times when completing this assignment.
