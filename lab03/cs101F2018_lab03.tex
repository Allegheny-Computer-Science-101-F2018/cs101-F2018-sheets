...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-101-S2018/computer-science-101-fall-2018-lab-3-gkapfham.git
\end{lstlisting}
...
consider adding the more test cases. You should incrementally complete this
